## Desafio Ignite Introducao Solid
## Users Manager - API

Projeto tem por finalidade exercitar o conteúdo referente a SOLID visto no curso de NodeJs na Rocketseat.

Foi disponibilizado um template com um código em desenvolvimento, onde foi necessários entender o código e aplicar as correções necessárias, fazendo que todos os testes passem.

Os testes que ajudaram no desenvolvimento do app e conclusão do desafio já estavam contidos no template.
...
- Pesquisa e retorna usuário pelo ID;
...
- Express
- uuid
- ts-node-dev (dependência de desenvolvimento)
